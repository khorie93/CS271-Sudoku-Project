...
public class SudokuBTSConstraintMRVnMAVDriver
{
	...
	public static void main(String[] args) throws FileNotFoundException, InconsistentSudokuException
	{
		...
		ps = new PrintStream("./BTSConstraintMRVnMAV2.csv");
		...
		for (int i = 0; i < n; i++)
		{
			...
			SudokuSolver sSolver = new BTSConstraintMRVnMAV(puzz);
			...
			System.out.println("BTSConstraintMRVnMAV  : " + i);
